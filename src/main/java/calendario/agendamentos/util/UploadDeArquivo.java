...
public class UploadDeArquivo {
	...
	public boolean salvaComNomeNormalizado(String nome) {
		try {
			String nomeNormalizado = Normalizador.deNomeArquivosOuDiretorios(nome);
			this.nomeDoArquivoSalvo = diretorio + nomeNormalizado;
			return noCaminho();
		} catch (Exception e) {
			this.erro = "salvaComNomeNormalizadoException";
			System.out.println(e);
