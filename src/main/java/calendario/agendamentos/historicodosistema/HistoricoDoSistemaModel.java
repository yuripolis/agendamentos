...
public class HistoricoDoSistemaModel implements Serializable  {
	...
	@Id
	@SequenceGenerator(name = "SequenciaHistoricoDoSistema", sequenceName = "SequenciaHistoricoDoSistema", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SequenciaHistoricoDoSistema")
	@Column(length = 19)
	private Long id;
