...
public class GerenciadorDeHistorico {
	...
	public void inserir(Object dadosAtuais, String local) {
		...
		historico.setLogin("id: " + String.valueOf(this.usuarioAdaptador.obterUsuarioLogado().getId()));
		historico.setNome(usuarioAdaptador.obterUsuarioLogado().getUsername());
		...
		for (Field field : dados.getClass().getDeclaredFields()) {
			if (!"serialVersionUID".equals(field.getName())) {
				...
				try {
					...
					} else if (field.getType().getName().contains("br.com.pyrsolutions.cartadeservicos")) {
